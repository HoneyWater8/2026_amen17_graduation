...
**이 절은 2026-09-26까지 사용한 저장소의 과거 기록이다. 새 영상 업로드·교체는 위 R2 절차를 사용한다.** 2026-09-27 사용자 요청으로 기존 Blob 파일 26개와 저장소를 삭제했다. 아래 주소·용량·업로드 명령은 당시 기록이며 현재 복구 경로가 아니다. R2 영상과 로컬 원본·full은 보존했다. [검증·삭제 기록](./worklog/2026-09-27-optimization-review.md).
